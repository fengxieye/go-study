...
//curl "http://localhost:9999/api?group=scores&key=stu2" & curl "http://localhost:9999/api?group=scores&key=stu2" & curl "http://localhost:9999/api?group=scores&key=stu2"
